      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          <div className="flex flex-col items-center p-4 md:p-6 rounded-2xl border-2 border-violet-100 hover:border-violet-300 transition-colors">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4">Fire Stick</h3>
            <Button variant="outline" className="w-full md:w-auto border-violet-500 text-violet-600 hover:bg-violet-50">
          ...
          <div className="flex flex-col items-center p-4 md:p-6 rounded-2xl border-2 border-emerald-100 hover:border-emerald-300 transition-colors">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4">Android</h3>
            <Button variant="outline" className="w-full md:w-auto border-emerald-500 text-emerald-600 hover:bg-emerald-50">
              Baixar para Android
            </Button>
          </div>
        </div>
